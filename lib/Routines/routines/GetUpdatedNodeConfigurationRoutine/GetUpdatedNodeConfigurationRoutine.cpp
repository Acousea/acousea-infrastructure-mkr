...
GetUpdatedNodeConfigurationRoutine::GetUpdatedNodeConfigurationRoutine(
    ...
    RTCController *rtcController) : IRoutine<acousea_CommunicationPacket>(getClassNameString()),
                                    nodeConfigurationRepository(nodeConfigurationRepository),
                                    moduleProxy(moduleProxy),
    ...
    const std::optional<acousea_CommunicationPacket> &optPacket)
{
    ...
    acousea_GetUpdatedNodeConfigurationPayload requestedConfigurationPayload = packet.body.command.command.requestedConfiguration;
